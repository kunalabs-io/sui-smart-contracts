...
<b>use</b> <a href="../../dependencies/cetus_clmm/acl.md#cetus_clmm_acl">cetus_clmm::acl</a>;
<b>use</b> <a href="../../dependencies/cetus_clmm/clmm_math.md#cetus_clmm_clmm_math">cetus_clmm::clmm_math</a>;
<b>use</b> <a href="../../dependencies/cetus_clmm/config.md#cetus_clmm_config">cetus_clmm::config</a>;
<b>use</b> <a href="../../dependencies/cetus_clmm/partner.md#cetus_clmm_partner">cetus_clmm::partner</a>;
<b>use</b> <a href="../../dependencies/cetus_clmm/pool.md#cetus_clmm_pool">cetus_clmm::pool</a>;
<b>use</b> <a href="../../dependencies/cetus_clmm/position.md#cetus_clmm_position">cetus_clmm::position</a>;
<b>use</b> <a href="../../dependencies/cetus_clmm/position_snapshot.md#cetus_clmm_position_snapshot">cetus_clmm::position_snapshot</a>;
<b>use</b> <a href="../../dependencies/cetus_clmm/rewarder.md#cetus_clmm_rewarder">cetus_clmm::rewarder</a>;
<b>use</b> <a href="../../dependencies/cetus_clmm/tick.md#cetus_clmm_tick">cetus_clmm::tick</a>;
<b>use</b> <a href="../../dependencies/cetus_clmm/tick_math.md#cetus_clmm_tick_math">cetus_clmm::tick_math</a>;
<b>use</b> <a href="../../dependencies/cetus_clmm/utils.md#cetus_clmm_utils">cetus_clmm::utils</a>;
<b>use</b> <a href="../../dependencies/integer_mate/full_math_u128.md#integer_mate_full_math_u128">integer_mate::full_math_u128</a>;
<b>use</b> <a href="../../dependencies/integer_mate/full_math_u64.md#integer_mate_full_math_u64">integer_mate::full_math_u64</a>;
...
<b>use</b> <a href="../../dependencies/integer_mate/math_u128.md#integer_mate_math_u128">integer_mate::math_u128</a>;
<b>use</b> <a href="../../dependencies/integer_mate/math_u256.md#integer_mate_math_u256">integer_mate::math_u256</a>;
<b>use</b> <a href="../../dependencies/integer_mate/math_u64.md#integer_mate_math_u64">integer_mate::math_u64</a>;
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/kai_leverage/cetus.md#kai_leverage_cetus_slippage_tolerance_assertion">slippage_tolerance_assertion</a>&lt;X, Y&gt;(pool: &<a href="../../dependencies/cetus_clmm/pool.md#cetus_clmm_pool_Pool">cetus_clmm::pool::Pool</a>&lt;X, Y&gt;, p0_desired_x128: u256, max_slippage_bps: u16)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/kai_leverage/cetus.md#kai_leverage_cetus_calc_deposit_amounts_by_liquidity">calc_deposit_amounts_by_liquidity</a>&lt;X, Y&gt;(pool: &<a href="../../dependencies/cetus_clmm/pool.md#cetus_clmm_pool_Pool">cetus_clmm::pool::Pool</a>&lt;X, Y&gt;, tick_a: <a href="../../dependencies/integer_mate/i32.md#integer_mate_i32_I32">integer_mate::i32::I32</a>, tick_b: <a href="../../dependencies/integer_mate/i32.md#integer_mate_i32_I32">integer_mate::i32::I32</a>, delta_l: u128): (u64, u64)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/kai_leverage/cetus.md#kai_leverage_cetus_remove_liquidity">remove_liquidity</a>&lt;X, Y&gt;(config: &<a href="../../dependencies/cetus_clmm/config.md#cetus_clmm_config_GlobalConfig">cetus_clmm::config::GlobalConfig</a>, pool: &<b>mut</b> <a href="../../dependencies/cetus_clmm/pool.md#cetus_clmm_pool_Pool">cetus_clmm::pool::Pool</a>&lt;X, Y&gt;, lp_position: &<b>mut</b> <a href="../../dependencies/cetus_clmm/position.md#cetus_clmm_position_Position">cetus_clmm::position::Position</a>, delta_l: u128, clock: &<a href="../../dependencies/sui/clock.md#sui_clock_Clock">sui::clock::Clock</a>): (<a href="../../dependencies/sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;X&gt;, <a href="../../dependencies/sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;Y&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/kai_leverage/cetus.md#kai_leverage_cetus_create_position">create_position</a>&lt;X, Y&gt;(config: &<a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_PositionConfig">kai_leverage::position_core_clmm::PositionConfig</a>, ticket: <a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_CreatePositionTicket">kai_leverage::position_core_clmm::CreatePositionTicket</a>&lt;X, Y, <a href="../../dependencies/integer_mate/i32.md#integer_mate_i32_I32">integer_mate::i32::I32</a>&gt;, cetus_pool: &<b>mut</b> <a href="../../dependencies/cetus_clmm/pool.md#cetus_clmm_pool_Pool">cetus_clmm::pool::Pool</a>&lt;X, Y&gt;, cetus_global_config: &<a href="../../dependencies/cetus_clmm/config.md#cetus_clmm_config_GlobalConfig">cetus_clmm::config::GlobalConfig</a>, creation_fee: <a href="../../dependencies/sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;<a href="../../dependencies/sui/sui.md#sui_sui_SUI">sui::sui::SUI</a>&gt;, clock: &<a href="../../dependencies/sui/clock.md#sui_clock_Clock">sui::clock::Clock</a>, ctx: &<b>mut</b> <a href="../../dependencies/sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): <a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_PositionCap">kai_leverage::position_core_clmm::PositionCap</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/kai_leverage/cetus.md#kai_leverage_cetus_create_deleverage_ticket">create_deleverage_ticket</a>&lt;X, Y&gt;(position: &<b>mut</b> <a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_Position">kai_leverage::position_core_clmm::Position</a>&lt;X, Y, <a href="../../dependencies/cetus_clmm/position.md#cetus_clmm_position_Position">cetus_clmm::position::Position</a>&gt;, config: &<b>mut</b> <a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_PositionConfig">kai_leverage::position_core_clmm::PositionConfig</a>, price_info: &<a href="../../dependencies/kai_leverage/pyth.md#kai_leverage_pyth_PythPriceInfo">kai_leverage::pyth::PythPriceInfo</a>, debt_info: &<a href="../../dependencies/kai_leverage/debt_info.md#kai_leverage_debt_info_DebtInfo">kai_leverage::debt_info::DebtInfo</a>, cetus_pool: &<b>mut</b> <a href="../../dependencies/cetus_clmm/pool.md#cetus_clmm_pool_Pool">cetus_clmm::pool::Pool</a>&lt;X, Y&gt;, cetus_global_config: &<a href="../../dependencies/cetus_clmm/config.md#cetus_clmm_config_GlobalConfig">cetus_clmm::config::GlobalConfig</a>, max_delta_l: u128, clock: &<a href="../../dependencies/sui/clock.md#sui_clock_Clock">sui::clock::Clock</a>, ctx: &<b>mut</b> <a href="../../dependencies/sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): (<a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_DeleverageTicket">kai_leverage::position_core_clmm::DeleverageTicket</a>, <a href="../../dependencies/access_management/access.md#access_management_access_ActionRequest">access_management::access::ActionRequest</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/kai_leverage/cetus.md#kai_leverage_cetus_deleverage">deleverage</a>&lt;X, Y, SX, SY&gt;(position: &<b>mut</b> <a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_Position">kai_leverage::position_core_clmm::Position</a>&lt;X, Y, <a href="../../dependencies/cetus_clmm/position.md#cetus_clmm_position_Position">cetus_clmm::position::Position</a>&gt;, config: &<b>mut</b> <a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_PositionConfig">kai_leverage::position_core_clmm::PositionConfig</a>, price_info: &<a href="../../dependencies/kai_leverage/pyth.md#kai_leverage_pyth_PythPriceInfo">kai_leverage::pyth::PythPriceInfo</a>, supply_pool_x: &<b>mut</b> <a href="../../dependencies/kai_leverage/supply_pool.md#kai_leverage_supply_pool_SupplyPool">kai_leverage::supply_pool::SupplyPool</a>&lt;X, SX&gt;, supply_pool_y: &<b>mut</b> <a href="../../dependencies/kai_leverage/supply_pool.md#kai_leverage_supply_pool_SupplyPool">kai_leverage::supply_pool::SupplyPool</a>&lt;Y, SY&gt;, cetus_pool: &<b>mut</b> <a href="../../dependencies/cetus_clmm/pool.md#cetus_clmm_pool_Pool">cetus_clmm::pool::Pool</a>&lt;X, Y&gt;, cetus_global_config: &<a href="../../dependencies/cetus_clmm/config.md#cetus_clmm_config_GlobalConfig">cetus_clmm::config::GlobalConfig</a>, max_delta_l: u128, clock: &<a href="../../dependencies/sui/clock.md#sui_clock_Clock">sui::clock::Clock</a>, ctx: &<b>mut</b> <a href="../../dependencies/sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): <a href="../../dependencies/access_management/access.md#access_management_access_ActionRequest">access_management::access::ActionRequest</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/kai_leverage/cetus.md#kai_leverage_cetus_deleverage">deleverage</a>&lt;X, Y, SX, SY&gt;(
    ...
    <b>let</b> (<b>mut</b> ticket, request) = <a href="../../dependencies/kai_leverage/cetus.md#kai_leverage_cetus_create_deleverage_ticket">create_deleverage_ticket</a>(
        position,
        config,
        price_info,
        &debt_info,
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/kai_leverage/cetus.md#kai_leverage_cetus_deleverage_for_liquidation">deleverage_for_liquidation</a>&lt;X, Y, SX, SY&gt;(
    ...
    debt_info.add_from_supply_pool(supply_pool_x, clock);
    debt_info.add_from_supply_pool(supply_pool_y, clock);
    <b>let</b> <b>mut</b> ticket = <a href="../../dependencies/kai_leverage/cetus.md#kai_leverage_cetus_create_deleverage_ticket_for_liquidation">create_deleverage_ticket_for_liquidation</a>(
        position,
        config,
        price_info,
        &debt_info,
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/kai_leverage/cetus.md#kai_leverage_cetus_reduce">reduce</a>&lt;X, Y, SX, SY&gt;(position: &<b>mut</b> <a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_Position">kai_leverage::position_core_clmm::Position</a>&lt;X, Y, <a href="../../dependencies/cetus_clmm/position.md#cetus_clmm_position_Position">cetus_clmm::position::Position</a>&gt;, config: &<b>mut</b> <a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_PositionConfig">kai_leverage::position_core_clmm::PositionConfig</a>, cap: &<a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_PositionCap">kai_leverage::position_core_clmm::PositionCap</a>, price_info: &<a href="../../dependencies/kai_leverage/pyth.md#kai_leverage_pyth_PythPriceInfo">kai_leverage::pyth::PythPriceInfo</a>, supply_pool_x: &<b>mut</b> <a href="../../dependencies/kai_leverage/supply_pool.md#kai_leverage_supply_pool_SupplyPool">kai_leverage::supply_pool::SupplyPool</a>&lt;X, SX&gt;, supply_pool_y: &<b>mut</b> <a href="../../dependencies/kai_leverage/supply_pool.md#kai_leverage_supply_pool_SupplyPool">kai_leverage::supply_pool::SupplyPool</a>&lt;Y, SY&gt;, cetus_pool: &<b>mut</b> <a href="../../dependencies/cetus_clmm/pool.md#cetus_clmm_pool_Pool">cetus_clmm::pool::Pool</a>&lt;X, Y&gt;, cetus_global_config: &<a href="../../dependencies/cetus_clmm/config.md#cetus_clmm_config_GlobalConfig">cetus_clmm::config::GlobalConfig</a>, factor_x64: u128, clock: &<a href="../../dependencies/sui/clock.md#sui_clock_Clock">sui::clock::Clock</a>): (<a href="../../dependencies/sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;X&gt;, <a href="../../dependencies/sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;Y&gt;, <a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_ReductionRepaymentTicket">kai_leverage::position_core_clmm::ReductionRepaymentTicket</a>&lt;SX, SY&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/kai_leverage/cetus.md#kai_leverage_cetus_add_liquidity">add_liquidity</a>&lt;X, Y&gt;(position: &<b>mut</b> <a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_Position">kai_leverage::position_core_clmm::Position</a>&lt;X, Y, <a href="../../dependencies/cetus_clmm/position.md#cetus_clmm_position_Position">cetus_clmm::position::Position</a>&gt;, config: &<b>mut</b> <a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_PositionConfig">kai_leverage::position_core_clmm::PositionConfig</a>, cap: &<a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_PositionCap">kai_leverage::position_core_clmm::PositionCap</a>, price_info: &<a href="../../dependencies/kai_leverage/pyth.md#kai_leverage_pyth_PythPriceInfo">kai_leverage::pyth::PythPriceInfo</a>, debt_info: &<a href="../../dependencies/kai_leverage/debt_info.md#kai_leverage_debt_info_DebtInfo">kai_leverage::debt_info::DebtInfo</a>, cetus_pool: &<b>mut</b> <a href="../../dependencies/cetus_clmm/pool.md#cetus_clmm_pool_Pool">cetus_clmm::pool::Pool</a>&lt;X, Y&gt;, cetus_config: &<a href="../../dependencies/cetus_clmm/config.md#cetus_clmm_config_GlobalConfig">cetus_clmm::config::GlobalConfig</a>, delta_l: u128, clock: &<a href="../../dependencies/sui/clock.md#sui_clock_Clock">sui::clock::Clock</a>): <a href="../../dependencies/cetus_clmm/pool.md#cetus_clmm_pool_AddLiquidityReceipt">cetus_clmm::pool::AddLiquidityReceipt</a>&lt;X, Y&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/kai_leverage/cetus.md#kai_leverage_cetus_add_liquidity_fix_coin">add_liquidity_fix_coin</a>&lt;X, Y&gt;(_position: &<b>mut</b> <a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_Position">kai_leverage::position_core_clmm::Position</a>&lt;X, Y, <a href="../../dependencies/cetus_clmm/position.md#cetus_clmm_position_Position">cetus_clmm::position::Position</a>&gt;, _config: &<b>mut</b> <a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_PositionConfig">kai_leverage::position_core_clmm::PositionConfig</a>, _cap: &<a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_PositionCap">kai_leverage::position_core_clmm::PositionCap</a>, _price_info: &<a href="../../dependencies/kai_leverage/pyth.md#kai_leverage_pyth_PythPriceInfo">kai_leverage::pyth::PythPriceInfo</a>, _debt_info: &<a href="../../dependencies/kai_leverage/debt_info.md#kai_leverage_debt_info_DebtInfo">kai_leverage::debt_info::DebtInfo</a>, _cetus_pool: &<b>mut</b> <a href="../../dependencies/cetus_clmm/pool.md#cetus_clmm_pool_Pool">cetus_clmm::pool::Pool</a>&lt;X, Y&gt;, _cetus_config: &<a href="../../dependencies/cetus_clmm/config.md#cetus_clmm_config_GlobalConfig">cetus_clmm::config::GlobalConfig</a>, _amount: u64, _fix_amount_x: bool, _clock: &<a href="../../dependencies/sui/clock.md#sui_clock_Clock">sui::clock::Clock</a>): <a href="../../dependencies/cetus_clmm/pool.md#cetus_clmm_pool_AddLiquidityReceipt">cetus_clmm::pool::AddLiquidityReceipt</a>&lt;X, Y&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/kai_leverage/cetus.md#kai_leverage_cetus_owner_collect_fee">owner_collect_fee</a>&lt;X, Y&gt;(position: &<b>mut</b> <a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_Position">kai_leverage::position_core_clmm::Position</a>&lt;X, Y, <a href="../../dependencies/cetus_clmm/position.md#cetus_clmm_position_Position">cetus_clmm::position::Position</a>&gt;, config: &<a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_PositionConfig">kai_leverage::position_core_clmm::PositionConfig</a>, cap: &<a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_PositionCap">kai_leverage::position_core_clmm::PositionCap</a>, cetus_pool: &<b>mut</b> <a href="../../dependencies/cetus_clmm/pool.md#cetus_clmm_pool_Pool">cetus_clmm::pool::Pool</a>&lt;X, Y&gt;, cetus_config: &<a href="../../dependencies/cetus_clmm/config.md#cetus_clmm_config_GlobalConfig">cetus_clmm::config::GlobalConfig</a>): (<a href="../../dependencies/sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;X&gt;, <a href="../../dependencies/sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;Y&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/kai_leverage/cetus.md#kai_leverage_cetus_owner_collect_reward">owner_collect_reward</a>&lt;X, Y, T&gt;(position: &<b>mut</b> <a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_Position">kai_leverage::position_core_clmm::Position</a>&lt;X, Y, <a href="../../dependencies/cetus_clmm/position.md#cetus_clmm_position_Position">cetus_clmm::position::Position</a>&gt;, config: &<a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_PositionConfig">kai_leverage::position_core_clmm::PositionConfig</a>, cap: &<a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_PositionCap">kai_leverage::position_core_clmm::PositionCap</a>, cetus_pool: &<b>mut</b> <a href="../../dependencies/cetus_clmm/pool.md#cetus_clmm_pool_Pool">cetus_clmm::pool::Pool</a>&lt;X, Y&gt;, cetus_config: &<a href="../../dependencies/cetus_clmm/config.md#cetus_clmm_config_GlobalConfig">cetus_clmm::config::GlobalConfig</a>, cetus_vault: &<b>mut</b> <a href="../../dependencies/cetus_clmm/rewarder.md#cetus_clmm_rewarder_RewarderGlobalVault">cetus_clmm::rewarder::RewarderGlobalVault</a>, clock: &<a href="../../dependencies/sui/clock.md#sui_clock_Clock">sui::clock::Clock</a>): <a href="../../dependencies/sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/kai_leverage/cetus.md#kai_leverage_cetus_sync_exploited_position_liquidity_by_small_withdraw">sync_exploited_position_liquidity_by_small_withdraw</a>&lt;X, Y&gt;(position: &<b>mut</b> <a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_Position">kai_leverage::position_core_clmm::Position</a>&lt;X, Y, <a href="../../dependencies/cetus_clmm/position.md#cetus_clmm_position_Position">cetus_clmm::position::Position</a>&gt;, config: &<b>mut</b> <a href="../../dependencies/kai_leverage/position_core.md#kai_leverage_position_core_clmm_PositionConfig">kai_leverage::position_core_clmm::PositionConfig</a>, cetus_config: &<a href="../../dependencies/cetus_clmm/config.md#cetus_clmm_config_GlobalConfig">cetus_clmm::config::GlobalConfig</a>, cetus_pool: &<b>mut</b> <a href="../../dependencies/cetus_clmm/pool.md#cetus_clmm_pool_Pool">cetus_clmm::pool::Pool</a>&lt;X, Y&gt;, balance_bag: &<b>mut</b> <a href="../../dependencies/kai_leverage/balance_bag.md#kai_leverage_balance_bag_BalanceBag">kai_leverage::balance_bag::BalanceBag</a>, clock: &<a href="../../dependencies/sui/clock.md#sui_clock_Clock">sui::clock::Clock</a>, ctx: &<b>mut</b> <a href="../../dependencies/sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): <a href="../../dependencies/access_management/access.md#access_management_access_ActionRequest">access_management::access::ActionRequest</a>
</code></pre>
