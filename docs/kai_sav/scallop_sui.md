...
<pre><code><b>fun</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_assert_scallop_pool">assert_scallop_pool</a>(pool: &(scallop_pool=0xE87F1B2D498106A2C61421CEC75B7B5C5E348512B0DC263949A0E7A3C256571A)::spool::Spool)
</code></pre>
...
<pre><code><b>fun</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_assert_scallop_pool">assert_scallop_pool</a>(pool: &ScallopPool) {
    <b>assert</b>!(object::id_address(pool) == <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_SCALLOP_POOL_ID">SCALLOP_POOL_ID</a>, <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_EInvalidScallopPool">EInvalidScallopPool</a>);
}
</code></pre>
...
<pre><code><b>public</b>(package) <b>entry</b> <b>fun</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_new">new</a>(scallop_pool: &<b>mut</b> ScallopPool, clock: &Clock, ctx: &<b>mut</b> TxContext) {
    <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_assert_scallop_pool">assert_scallop_pool</a>(scallop_pool);
    <b>let</b> admin_cap = <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_AdminCap">AdminCap</a> { id: object::new(ctx) };
    ...
    <b>let</b> strategy = <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_Strategy">Strategy</a> {
        id: object::new(ctx),
        admin_cap_id,
        ...
        version: <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_MODULE_VERSION">MODULE_VERSION</a>,
    };
...
<pre><code><b>fun</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_assert_version">assert_version</a>(strategy: &<a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_Strategy">Strategy</a>) {
    <b>assert</b>!(strategy.version == <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_MODULE_VERSION">MODULE_VERSION</a>, <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_EWrongVersion">EWrongVersion</a>);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_assert_admin">assert_admin</a>(cap: &<a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_AdminCap">AdminCap</a>, strategy: &<a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_Strategy">Strategy</a>) {
    <b>let</b> admin_cap_id = object::id(cap);
    <b>assert</b>!(admin_cap_id == strategy.admin_cap_id, <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_EInvalidAdmin">EInvalidAdmin</a>);
}
</code></pre>
...
<pre><code><b>entry</b> <b>fun</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_join_vault">join_vault</a>(
    vault_cap: &VaultAdminCap&lt;YSUI&gt;,
    <a href="../kai_sav/vault.md#kai_sav_vault">vault</a>: &<b>mut</b> Vault&lt;SUI, YSUI&gt;,
    strategy_cap: &<a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_AdminCap">AdminCap</a>,
    strategy: &<b>mut</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_Strategy">Strategy</a>,
    ctx: &<b>mut</b> TxContext,
) {
    <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_assert_version">assert_version</a>(strategy);
    <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_assert_admin">assert_admin</a>(strategy_cap, strategy);
...
<pre><code><b>fun</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_assert_scallop_market">assert_scallop_market</a>(market: &(scallop_protocol=0xEFE8B36D5B2E43728CC323298626B83177803521D195CFB11E15B910E892FDDF)::market::Market)
</code></pre>
...
<pre><code><b>fun</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_assert_scallop_market">assert_scallop_market</a>(market: &ScallopMarket) {
    <b>assert</b>!(object::id_address(market) == <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_SCALLOP_MARKET_ID">SCALLOP_MARKET_ID</a>, <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_EInvalidScallopMarket">EInvalidScallopMarket</a>);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_assert_scallop_rewards_pool">assert_scallop_rewards_pool</a>(pool: &(scallop_pool=0xE87F1B2D498106A2C61421CEC75B7B5C5E348512B0DC263949A0E7A3C256571A)::rewards_pool::RewardsPool&lt;<a href="../dependencies/sui/sui.md#sui_sui_SUI">sui::sui::SUI</a>&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_assert_scallop_rewards_pool">assert_scallop_rewards_pool</a>(pool: &ScallopRewardsPool&lt;SUI&gt;) {
    <b>assert</b>!(object::id_address(pool) == <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_SCALLOP_REWARDS_POOL_ID">SCALLOP_REWARDS_POOL_ID</a>, <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_EInvalidScallopMarket">EInvalidScallopMarket</a>);
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_remove_from_vault">remove_from_vault</a>(
    cap: &<a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_AdminCap">AdminCap</a>,
    strategy: &<b>mut</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_Strategy">Strategy</a>,
    ...
    <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_assert_admin">assert_admin</a>(cap, strategy);
    <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_assert_version">assert_version</a>(strategy);
    <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_assert_scallop_market">assert_scallop_market</a>(scallop_market);
    <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_assert_scallop_pool">assert_scallop_pool</a>(scallop_pool);
    <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_assert_scallop_rewards_pool">assert_scallop_rewards_pool</a>(scallop_rewards_pool);
    ...
    <b>assert</b>!(coin::value(&rewards) == 0, <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_EHasPendingRewards">EHasPendingRewards</a>);
    <b>assert</b>!(balance::value(&strategy.collected_profit_sui) == 0, <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_EHasPendingRewards">EHasPendingRewards</a>);
...
<a name="kai_sav_scallop_sui_migrate"></a>
...
<pre><code><b>entry</b> <b>fun</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_migrate">migrate</a>(cap: &<a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_AdminCap">AdminCap</a>, strategy: &<b>mut</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_Strategy">Strategy</a>) {
    <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_assert_admin">assert_admin</a>(cap, strategy);
    <b>assert</b>!(strategy.version &lt; <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_MODULE_VERSION">MODULE_VERSION</a>, <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_ENotUpgrade">ENotUpgrade</a>);
    strategy.version = <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_MODULE_VERSION">MODULE_VERSION</a>;
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_rebalance">rebalance</a>(
    cap: &<a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_AdminCap">AdminCap</a>,
    strategy: &<b>mut</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_Strategy">Strategy</a>,
    <a href="../kai_sav/vault.md#kai_sav_vault">vault</a>: &<b>mut</b> Vault&lt;SUI, YSUI&gt;,
...
<pre><code><b>public</b> <b>fun</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_collect_and_hand_over_profit">collect_and_hand_over_profit</a>(cap: &<a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_AdminCap">kai_sav::scallop_sui::AdminCap</a>, strategy: &<b>mut</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_Strategy">kai_sav::scallop_sui::Strategy</a>, <a href="../kai_sav/vault.md#kai_sav_vault">vault</a>: &<b>mut</b> <a href="../kai_sav/vault.md#kai_sav_vault_Vault">kai_sav::vault::Vault</a>&lt;<a href="../dependencies/sui/sui.md#sui_sui_SUI">sui::sui::SUI</a>, <a href="../kai_sav/ysui.md#kai_sav_ysui_YSUI">kai_sav::ysui::YSUI</a>&gt;, scallop_pool: &<b>mut</b> (scallop_pool=0xE87F1B2D498106A2C61421CEC75B7B5C5E348512B0DC263949A0E7A3C256571A)::spool::Spool, scallop_rewards_pool: &<b>mut</b> (scallop_pool=0xE87F1B2D498106A2C61421CEC75B7B5C5E348512B0DC263949A0E7A3C256571A)::rewards_pool::RewardsPool&lt;<a href="../dependencies/sui/sui.md#sui_sui_SUI">sui::sui::SUI</a>&gt;, clock: &<a href="../dependencies/sui/clock.md#sui_clock_Clock">sui::clock::Clock</a>, ctx: &<b>mut</b> <a href="../dependencies/sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_collect_and_hand_over_profit">collect_and_hand_over_profit</a>(
    cap: &<a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_AdminCap">AdminCap</a>,
    strategy: &<b>mut</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_Strategy">Strategy</a>,
    <a href="../kai_sav/vault.md#kai_sav_vault">vault</a>: &<b>mut</b> Vault&lt;SUI, YSUI&gt;,
    scallop_pool: &<b>mut</b> ScallopPool,
...
<pre><code><b>public</b> <b>fun</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_withdraw">withdraw</a>(
    strategy: &<b>mut</b> <a href="../kai_sav/scallop_sui.md#kai_sav_scallop_sui_Strategy">Strategy</a>,
