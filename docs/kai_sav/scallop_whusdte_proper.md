...
<b>use</b> <a href="../dependencies/whusdte/coin.md#whusdte_coin">whusdte::coin</a>;
<b>use</b> x::ac_table;
...
<dt>
<code>scallop_pool_acc: (scallop_pool=0xE87F1B2D498106A2C61421CEC75B7B5C5E348512B0DC263949A0E7A3C256571A)::spool_account::SpoolAccount&lt;(scallop_protocol=0xEFE8B36D5B2E43728CC323298626B83177803521D195CFB11E15B910E892FDDF)::reserve::MarketCoin&lt;<a href="../dependencies/whusdte/coin.md#whusdte_coin_COIN">whusdte::coin::COIN</a>&gt;&gt;</code>
</dt>
<dd>
</dd>
<dt>
<code>underlying_nominal_value_usdt: u64</code>
</dt>
<dd>
</dd>
<dt>
<code>collected_profit_usdt: <a href="../dependencies/sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;<a href="../dependencies/whusdte/coin.md#whusdte_coin_COIN">whusdte::coin::COIN</a>&gt;</code>
</dt>
<dd>
</dd>
<dt>
...
<pre><code><b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_scallop_pool">assert_scallop_pool</a>(pool: &(scallop_pool=0xE87F1B2D498106A2C61421CEC75B7B5C5E348512B0DC263949A0E7A3C256571A)::spool::Spool)
</code></pre>
...
<pre><code><b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_scallop_pool">assert_scallop_pool</a>(pool: &ScallopPool) {
    <b>assert</b>!(object::id_address(pool) == <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_SCALLOP_POOL_ID">SCALLOP_POOL_ID</a>, <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_EInvalidScallopPool">EInvalidScallopPool</a>);
}
</code></pre>
...
<pre><code><b>public</b>(package) <b>entry</b> <b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_new">new</a>(scallop_pool: &<b>mut</b> ScallopPool, clock: &Clock, ctx: &<b>mut</b> TxContext) {
    <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_scallop_pool">assert_scallop_pool</a>(scallop_pool);
    <b>let</b> admin_cap = <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_AdminCap">AdminCap</a> { id: object::new(ctx) };
    ...
    <b>let</b> strategy = <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_Strategy">Strategy</a> {
        id: object::new(ctx),
        admin_cap_id,
        ...
        version: <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_MODULE_VERSION">MODULE_VERSION</a>,
    };
...
<pre><code><b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_version">assert_version</a>(strategy: &<a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_Strategy">Strategy</a>) {
    <b>assert</b>!(strategy.version == <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_MODULE_VERSION">MODULE_VERSION</a>, <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_EWrongVersion">EWrongVersion</a>);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_admin">assert_admin</a>(cap: &<a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_AdminCap">AdminCap</a>, strategy: &<a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_Strategy">Strategy</a>) {
    <b>let</b> admin_cap_id = object::id(cap);
    <b>assert</b>!(admin_cap_id == strategy.admin_cap_id, <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_EInvalidAdmin">EInvalidAdmin</a>);
}
</code></pre>
...
<pre><code><b>entry</b> <b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_join_vault">join_vault</a>(
    vault_cap: &VaultAdminCap&lt;YWHUSDTE&gt;,
    <a href="../kai_sav/vault.md#kai_sav_vault">vault</a>: &<b>mut</b> Vault&lt;WHUSDTE, YWHUSDTE&gt;,
    strategy_cap: &<a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_AdminCap">AdminCap</a>,
    strategy: &<b>mut</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_Strategy">Strategy</a>,
    ctx: &<b>mut</b> TxContext,
) {
    <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_version">assert_version</a>(strategy);
    <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_admin">assert_admin</a>(strategy_cap, strategy);
...
<pre><code><b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_scallop_market">assert_scallop_market</a>(market: &(scallop_protocol=0xEFE8B36D5B2E43728CC323298626B83177803521D195CFB11E15B910E892FDDF)::market::Market)
</code></pre>
...
<pre><code><b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_scallop_market">assert_scallop_market</a>(market: &ScallopMarket) {
    <b>assert</b>!(object::id_address(market) == <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_SCALLOP_MARKET_ID">SCALLOP_MARKET_ID</a>, <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_EInvalidScallopMarket">EInvalidScallopMarket</a>);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_scallop_rewards_pool">assert_scallop_rewards_pool</a>(pool: &(scallop_pool=0xE87F1B2D498106A2C61421CEC75B7B5C5E348512B0DC263949A0E7A3C256571A)::rewards_pool::RewardsPool&lt;<a href="../dependencies/sui/sui.md#sui_sui_SUI">sui::sui::SUI</a>&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_scallop_rewards_pool">assert_scallop_rewards_pool</a>(pool: &ScallopRewardsPool&lt;SUI&gt;) {
    <b>assert</b>!(object::id_address(pool) == <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_SCALLOP_REWARDS_POOL_ID">SCALLOP_REWARDS_POOL_ID</a>, <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_EInvalidScallopMarket">EInvalidScallopMarket</a>);
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_remove_from_vault">remove_from_vault</a>(
    cap: &<a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_AdminCap">AdminCap</a>,
    strategy: &<b>mut</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_Strategy">Strategy</a>,
    ...
    <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_admin">assert_admin</a>(cap, strategy);
    <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_version">assert_version</a>(strategy);
    <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_scallop_market">assert_scallop_market</a>(scallop_market);
    <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_scallop_pool">assert_scallop_pool</a>(scallop_pool);
    <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_scallop_rewards_pool">assert_scallop_rewards_pool</a>(scallop_rewards_pool);
    ...
    <b>assert</b>!(coin::value(&rewards) == 0, <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_EHasPendingRewards">EHasPendingRewards</a>);
    <b>assert</b>!(balance::value(&strategy.collected_profit_sui) == 0, <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_EHasPendingRewards">EHasPendingRewards</a>);
    coin::destroy_zero(rewards);
    <b>let</b> amount_susdt = <a href="../dependencies/scallop_pool/spool_account.md#(spool=0xE87F1B2D498106A2C61421CEC75B7B5C5E348512B0DC263949A0E7A3C256571A)_spool_account_stake_amount">scallop_pool::spool_account::stake_amount</a>(&strategy.scallop_pool_acc);
    <b>let</b> unstaked_susdt = <a href="../dependencies/scallop_pool/user.md#(spool=0xE87F1B2D498106A2C61421CEC75B7B5C5E348512B0DC263949A0E7A3C256571A)_user_unstake">scallop_pool::user::unstake</a>(
        scallop_pool,
        &<b>mut</b> strategy.scallop_pool_acc,
        amount_susdt,
        clock,
    ...
    <b>let</b> <b>mut</b> returned_balance = coin::into_balance(redeemed_coin);
    balance::join(
        &<b>mut</b> returned_balance,
        balance::withdraw_all(&<b>mut</b> strategy.collected_profit_usdt),
    );
...
<pre><code><b>entry</b> <b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_migrate">migrate</a>(cap: &<a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_AdminCap">AdminCap</a>, strategy: &<b>mut</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_Strategy">Strategy</a>) {
    <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_admin">assert_admin</a>(cap, strategy);
    <b>assert</b>!(strategy.version &lt; <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_MODULE_VERSION">MODULE_VERSION</a>, <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_ENotUpgrade">ENotUpgrade</a>);
    strategy.version = <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_MODULE_VERSION">MODULE_VERSION</a>;
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_rebalance">rebalance</a>(
    cap: &<a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_AdminCap">AdminCap</a>,
    strategy: &<b>mut</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_Strategy">Strategy</a>,
    <a href="../kai_sav/vault.md#kai_sav_vault">vault</a>: &<b>mut</b> Vault&lt;WHUSDTE, YWHUSDTE&gt;,
    ...
    <b>if</b> (to_repay &gt; 0) {
        <b>let</b> staked_amount_susdt = <a href="../dependencies/scallop_pool/spool_account.md#(spool=0xE87F1B2D498106A2C61421CEC75B7B5C5E348512B0DC263949A0E7A3C256571A)_spool_account_stake_amount">scallop_pool::spool_account::stake_amount</a>(
            &strategy.scallop_pool_acc,
        );
        <b>let</b> unstake_susdt_amt = muldiv(
            staked_amount_susdt,
            to_repay,
        ...
        <b>let</b> <b>mut</b> redeemed_balance_usdt = coin::into_balance(redeemed_coin);
        <b>if</b> (balance::value(&redeemed_balance_usdt) &gt; to_repay) {
            <b>let</b> extra_amt = balance::value(&redeemed_balance_usdt) - to_repay;
            balance::join(
                &<b>mut</b> strategy.collected_profit_usdt,
                balance::split(&<b>mut</b> redeemed_balance_usdt, extra_amt),
            );
        };
        <b>let</b> repaid = balance::value(&redeemed_balance_usdt);
        <a href="../kai_sav/vault.md#kai_sav_vault_strategy_repay">vault::strategy_repay</a>(<a href="../kai_sav/vault.md#kai_sav_vault">vault</a>, vault_access, redeemed_balance_usdt);
        ...
        <b>let</b> susdt = <a href="../dependencies/scallop_protocol/mint.md#(protocol=0xEFE8B36D5B2E43728CC323298626B83177803521D195CFB11E15B910E892FDDF)_mint_mint">scallop_protocol::mint::mint</a>(
            scallop_version,
            scallop_market,
            borrowed,
            clock,
        ...
        strategy.underlying_nominal_value_usdt =
            strategy.underlying_nominal_value_usdt + borrow_amt;
    }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_take_profits_for_selling">take_profits_for_selling</a>(cap: &<a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_AdminCap">kai_sav::scallop_whusdte_proper::AdminCap</a>, strategy: &<b>mut</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_Strategy">kai_sav::scallop_whusdte_proper::Strategy</a>, amount: <a href="../dependencies/std/option.md#std_option_Option">std::option::Option</a>&lt;u64&gt;, scallop_pool: &<b>mut</b> (scallop_pool=0xE87F1B2D498106A2C61421CEC75B7B5C5E348512B0DC263949A0E7A3C256571A)::spool::Spool, scallop_rewards_pool: &<b>mut</b> (scallop_pool=0xE87F1B2D498106A2C61421CEC75B7B5C5E348512B0DC263949A0E7A3C256571A)::rewards_pool::RewardsPool&lt;<a href="../dependencies/sui/sui.md#sui_sui_SUI">sui::sui::SUI</a>&gt;, clock: &<a href="../dependencies/sui/clock.md#sui_clock_Clock">sui::clock::Clock</a>, ctx: &<b>mut</b> <a href="../dependencies/sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>): <a href="../dependencies/sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;<a href="../dependencies/sui/sui.md#sui_sui_SUI">sui::sui::SUI</a>&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_take_profits_for_selling">take_profits_for_selling</a>(
    cap: &<a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_AdminCap">AdminCap</a>,
    strategy: &<b>mut</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_Strategy">Strategy</a>,
    amount: Option&lt;u64&gt;,
    scallop_pool: &<b>mut</b> ScallopPool,
    ...
    <b>if</b> (option::is_some(&amount)) {
        <b>let</b> amount = *option::borrow(&amount);
        balance::split(&<b>mut</b> strategy.collected_profit_sui, amount)
    } <b>else</b> {
        balance::withdraw_all(&<b>mut</b> strategy.collected_profit_sui)
    }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_skim_base_profits">skim_base_profits</a>(
    cap: &<a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_AdminCap">AdminCap</a>,
    strategy: &<b>mut</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_Strategy">Strategy</a>,
    scallop_version: &ScallopVersion,
    scallop_market: &<b>mut</b> ScallopMarket,
    ...
    <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_scallop_market">assert_scallop_market</a>(scallop_market);
    <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_scallop_pool">assert_scallop_pool</a>(scallop_pool);
    <b>let</b> staked_amount_susdt = <a href="../dependencies/scallop_pool/spool_account.md#(spool=0xE87F1B2D498106A2C61421CEC75B7B5C5E348512B0DC263949A0E7A3C256571A)_spool_account_stake_amount">scallop_pool::spool_account::stake_amount</a>(&strategy.scallop_pool_acc);
    <b>let</b> unstaked_susdt = <a href="../dependencies/scallop_pool/user.md#(spool=0xE87F1B2D498106A2C61421CEC75B7B5C5E348512B0DC263949A0E7A3C256571A)_user_unstake">scallop_pool::user::unstake</a>(
        scallop_pool,
        &<b>mut</b> strategy.scallop_pool_acc,
        staked_amount_susdt,
    ...
    <b>let</b> <b>mut</b> redeemed_balance_usdt = coin::into_balance(redeemed_coin);
    <b>if</b> (balance::value(&redeemed_balance_usdt) &gt; strategy.underlying_nominal_value_usdt) {
        <b>let</b> profit_amt =
            balance::value(&redeemed_balance_usdt) - strategy.underlying_nominal_value_usdt;
        balance::join(
            &<b>mut</b> strategy.collected_profit_usdt,
            balance::split(&<b>mut</b> redeemed_balance_usdt, profit_amt),
        );
    };
    <b>let</b> stake_coin = coin::from_balance(redeemed_balance_usdt, ctx);
...
<pre><code><b>public</b> <b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_deposit_sold_profits">deposit_sold_profits</a>(cap: &<a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_AdminCap">kai_sav::scallop_whusdte_proper::AdminCap</a>, strategy: &<b>mut</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_Strategy">kai_sav::scallop_whusdte_proper::Strategy</a>, <a href="../kai_sav/vault.md#kai_sav_vault">vault</a>: &<b>mut</b> <a href="../kai_sav/vault.md#kai_sav_vault_Vault">kai_sav::vault::Vault</a>&lt;<a href="../dependencies/whusdte/coin.md#whusdte_coin_COIN">whusdte::coin::COIN</a>, <a href="../dependencies/kai_ywhusdte_ysui/ywhusdte.md#kai_ywhusdte_ysui_ywhusdte_YWHUSDTE">kai_ywhusdte_ysui::ywhusdte::YWHUSDTE</a>&gt;, profit: <a href="../dependencies/sui/balance.md#sui_balance_Balance">sui::balance::Balance</a>&lt;<a href="../dependencies/whusdte/coin.md#whusdte_coin_COIN">whusdte::coin::COIN</a>&gt;, clock: &<a href="../dependencies/sui/clock.md#sui_clock_Clock">sui::clock::Clock</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_deposit_sold_profits">deposit_sold_profits</a>(
    cap: &<a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_AdminCap">AdminCap</a>,
    strategy: &<b>mut</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_Strategy">Strategy</a>,
    <a href="../kai_sav/vault.md#kai_sav_vault">vault</a>: &<b>mut</b> Vault&lt;WHUSDTE, YWHUSDTE&gt;,
    <b>mut</b> profit: Balance&lt;WHUSDTE&gt;,
    clock: &Clock,
) {
    <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_admin">assert_admin</a>(cap, strategy);
    <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_assert_version">assert_version</a>(strategy);
...
<pre><code><b>public</b> <b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_withdraw">withdraw</a>(strategy: &<b>mut</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_Strategy">kai_sav::scallop_whusdte_proper::Strategy</a>, ticket: &<b>mut</b> <a href="../kai_sav/vault.md#kai_sav_vault_WithdrawTicket">kai_sav::vault::WithdrawTicket</a>&lt;<a href="../dependencies/whusdte/coin.md#whusdte_coin_COIN">whusdte::coin::COIN</a>, <a href="../dependencies/kai_ywhusdte_ysui/ywhusdte.md#kai_ywhusdte_ysui_ywhusdte_YWHUSDTE">kai_ywhusdte_ysui::ywhusdte::YWHUSDTE</a>&gt;, scallop_version: &(scallop_protocol=0xEFE8B36D5B2E43728CC323298626B83177803521D195CFB11E15B910E892FDDF)::version::Version, scallop_market: &<b>mut</b> (scallop_protocol=0xEFE8B36D5B2E43728CC323298626B83177803521D195CFB11E15B910E892FDDF)::market::Market, scallop_pool: &<b>mut</b> (scallop_pool=0xE87F1B2D498106A2C61421CEC75B7B5C5E348512B0DC263949A0E7A3C256571A)::spool::Spool, clock: &<a href="../dependencies/sui/clock.md#sui_clock_Clock">sui::clock::Clock</a>, ctx: &<b>mut</b> <a href="../dependencies/sui/tx_context.md#sui_tx_context_TxContext">sui::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_withdraw">withdraw</a>(
    strategy: &<b>mut</b> <a href="../kai_sav/scallop_whusdte_proper.md#kai_sav_scallop_whusdte_proper_Strategy">Strategy</a>,
    ticket: &<b>mut</b> WithdrawTicket&lt;WHUSDTE, YWHUSDTE&gt;,
    scallop_version: &ScallopVersion,
    scallop_market: &<b>mut</b> ScallopMarket,
    scallop_pool: &<b>mut</b> ScallopPool,
    clock: &Clock,
    ...
    <b>let</b> <b>mut</b> redeemed_balance_usdt = coin::into_balance(redeemed_coin);
    <b>if</b> (balance::value(&redeemed_balance_usdt) &gt; to_withdraw) {
        <b>let</b> profit_amt = balance::value(&redeemed_balance_usdt) - to_withdraw;
        balance::join(
            &<b>mut</b> strategy.collected_profit_usdt,
            balance::split(&<b>mut</b> redeemed_balance_usdt, profit_amt),
        );
    };
    <a href="../kai_sav/vault.md#kai_sav_vault_strategy_withdraw_to_ticket">vault::strategy_withdraw_to_ticket</a>(ticket, vault_access, redeemed_balance_usdt);
