module move_stl::option_u64_tests {
    use move_stl::option_u64;
    use std::unit_test::assert_eq;

    #[test]
    fun test_some() {
        let o1 = option_u64::some(1);
        assert_eq!(o1.is_some(), true);
        assert_eq!(o1.is_none(), false);
        let o2 = option_u64::some(0);
