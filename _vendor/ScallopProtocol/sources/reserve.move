module scallop_protocol::reserve {
 ...
 #[native_interface]
    native public fun flash_loan_loan_amount<T0>(a0: &reserve::FlashLoan<T0>): u64;
 #[native_interface]
    native public fun flash_loan_fee<T0>(a0: &reserve::FlashLoan<T0>): u64;
 #[native_interface]
