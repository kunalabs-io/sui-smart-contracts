module scallop_protocol::market {
    ...
    use scallop_protocol::accrue_interest;
    use scallop_protocol::app;
    use scallop_protocol::asset_active_state;
    use scallop_protocol::borrow;
    use scallop_protocol::borrow_dynamics;
    use scallop_protocol::collateral_stats;
    use scallop_protocol::deposit_collateral;
    use scallop_protocol::flash_loan;
    use scallop_protocol::incentive_rewards;
    use scallop_protocol::interest_model;
    use scallop_protocol::limiter;
    use scallop_protocol::liquidate;
    use scallop_protocol::lock_obligation;
    use scallop_protocol::market;
    use scallop_protocol::mint;
    use scallop_protocol::redeem;
    use scallop_protocol::repay;
    use scallop_protocol::reserve;
    use scallop_protocol::risk_model;
    use scallop_protocol::withdraw_collateral;
