...
entry fun join_vault(
    ...
    vault: &mut Vault<WHUSDTE, YWHUSDTE>,
...
public fun rebalance(
    ...
    if (to_repay > 0) {
        let staked_amount_susdt = scallop_pool::spool_account::stake_amount(
...
public fun withdraw(
    strategy: &mut Strategy,
    ticket: &mut WithdrawTicket<WHUSDTE, YWHUSDTE>,
    scallop_version: &ScallopVersion,
    scallop_market: &mut ScallopMarket,
    scallop_pool: &mut ScallopPool,
    clock: &Clock,
