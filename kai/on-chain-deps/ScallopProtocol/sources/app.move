module 0xEFE8B36D5B2E43728CC323298626B83177803521D195CFB11E15B910E892FDDF::app {
 ...
 #[native_interface]
    native public entry fun update_supply_limit<T0: drop>(a0: &app::AdminCap, a1: &mut market::Market, a2: u64);
 #[native_interface]
    native public entry fun create_referral_witness_list(a0: &app::AdminCap, a1: &mut tx_context::TxContext);
 #[native_interface]
    native public entry fun add_referral_witness_list<T0: drop>(a0: &app::AdminCap, a1: &mut borrow_referral::AuthorizedWitnessList);
 #[native_interface]
    native public entry fun remove_referral_witness_list<T0: drop>(a0: &app::AdminCap, a1: &mut borrow_referral::AuthorizedWitnessList);
