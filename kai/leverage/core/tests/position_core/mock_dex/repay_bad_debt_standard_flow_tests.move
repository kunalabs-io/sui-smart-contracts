#[test_only]
module kai_leverage::position_core_mock_dex_repay_bad_debt_standard_flow_tests;
...
fun repay_bad_debt_x_standard_flow_is_correct() {
    ...
    let position_cap = macros::repay_bad_debt_x_standard_flow!(&mut setup);
...
fun repay_bad_debt_y_standard_flow_is_correct() {
    ...
    let position_cap = macros::repay_bad_debt_y_standard_flow!(&mut setup);
    destroy(position_cap);
