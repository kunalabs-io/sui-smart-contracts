#[test_only]
module kai_leverage::position_core_mock_dex_repay_bad_debt_tests;
...
#[test, expected_failure(abort_code = 22, location = mock_dex_integration)] // e_no_bad_debt_or_not_fully_liquidated
...
#[test, expected_failure(abort_code = 22, location = mock_dex_integration)] // e_position_not_below_bad_debt_threshold
...
#[test, expected_failure(abort_code = 22, location = mock_dex_integration)] // e_no_bad_debt_or_not_fully_liquidated
fun repay_bad_debt_y_aborts_when_position_not_fully_liquidated() {
    let mut setup = position_core_mock_dex_test_setup::new_setup();

    macros::repay_bad_debt_y_aborts_when_position_not_fully_liquidated!(&mut setup);
