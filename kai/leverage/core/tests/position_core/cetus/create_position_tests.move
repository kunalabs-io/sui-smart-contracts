...
#[test, expected_failure(abort_code = 3, location = cetus)] // e_new_positions_not_allowed
...
#[test, expected_failure(abort_code = 5, location = cetus)] // e_new_positions_not_allowed
...
#[test, expected_failure(abort_code = 13, location = cetus)] // e_position_size_limit_exceeded
...
#[test, expected_failure(abort_code = 14, location = cetus)] // e_vault_global_size_limit_exceeded
...
#[test, expected_failure(abort_code = 0, location = cetus)] // e_invalid_tick_range
...
#[test, expected_failure(abort_code = 1, location = cetus)] // e_liq_margin_too_low
...
#[test, expected_failure(abort_code = 2, location = cetus)] // e_initial_margin_too_low
...
fun borrow_for_position_x_is_idempotent() {
    let mut setup = position_core_cetus_test_setup::new_setup();
    position_core_create_position_test_macros::borrow_for_position_x_is_idempotent!(
        &mut setup,
    );
    setup.destroy();
}
...
fun borrow_for_position_y_is_idempotent() {
    let mut setup = position_core_cetus_test_setup::new_setup();
    position_core_create_position_test_macros::borrow_for_position_y_is_idempotent!(
        &mut setup,
    );
    setup.destroy();
}

#[test, expected_failure(abort_code = 15, location = cetus)] // e_invalid_creation_fee_amount
...
#[test, expected_failure(abort_code = 6, location = cetus)] // e_invalid_borrow
...
#[test, expected_failure(abort_code = 5, location = cetus)] // e_invalid_pool
